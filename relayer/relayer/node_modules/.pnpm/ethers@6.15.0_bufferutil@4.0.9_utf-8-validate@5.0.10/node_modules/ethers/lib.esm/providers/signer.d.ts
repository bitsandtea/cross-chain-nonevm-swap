import type { Addressable, NameResolver } from ".pnpm/ethers@6.15.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/ethers/address";
import type { AuthorizationRequest, TypedDataDomain, TypedDataField } from ".pnpm/ethers@6.15.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/ethers/hash";
import type { Authorization, TransactionLike } from ".pnpm/ethers@6.15.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/ethers/transaction";
