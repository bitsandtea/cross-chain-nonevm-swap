 ...
 */
import type { AlternateURLs, Languages, ResolvedAlternateURLs } from '.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/lib/metadata/types/alternative-urls-types';
import type { AppleWebApp, AppLinks, Facebook, FormatDetection, ItunesApp, Pinterest, ResolvedAppleWebApp, ResolvedAppLinks, ResolvedFacebook, ResolvedPinterest, ViewportLayout } from '.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/lib/metadata/types/extra-types';
import type { Manifest as ManifestFile } from '.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/lib/metadata/types/manifest-types';
import type { AbsoluteTemplateString, Author, ColorSchemeEnum, DeprecatedMetadataFields, Icon, Icons, IconURL, ReferrerEnum, ResolvedIcons, ResolvedRobots, ResolvedVerification, Robots, TemplateString, ThemeColorDescriptor, Verification, Videos } from '.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/lib/metadata/types/metadata-types';
import type { OpenGraph, ResolvedOpenGraph } from '.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/lib/metadata/types/opengraph-types';
import type { ResolvedTwitterMetadata, Twitter } from '.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/lib/metadata/types/twitter-types';
/**
...
export type { Metadata, MetadataRoute, ResolvedMetadata, ResolvedViewport, ResolvingMetadata, ResolvingViewport, Viewport };
